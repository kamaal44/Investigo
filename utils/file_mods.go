...
// https://github.com/nerdalert/gitnet-overlay/blob/master/plugin/gitnet/control/utils.go
// https://github.com/jrenslin/eAureumFV/blob/master/eAureum/indexing.go
